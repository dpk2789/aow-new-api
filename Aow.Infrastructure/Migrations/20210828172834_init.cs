        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppUserCompanies_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Type = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RelationalUnit = table.Column<decimal>(type: "decimal(18,4)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemUnits_ItemUnits_ParentId",
                        column: x => x.ParentId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpeningBalanceCrDr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PrintName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RegTaxNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    CompanyNameShipping = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ledgers_LedgerCategories_LedgerCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProductTaxCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Is_Taxable = table.Column<bool>(type: "bit", nullable: false),
                    ProductCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Ledgers_LedgerId",
                        column: x => x.LedgerId,
                        principalTable: "Ledgers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemGroupProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemGroupProducts_ProductGroups_ProductGroupId",
                        column: x => x.ProductGroupId,
                        principalTable: "ProductGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemGroupProducts_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Is_Taxable = table.Column<bool>(type: "bit", nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductAttributeOptions1Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductAttributeOptions2Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductAttributeOptionsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true)
            ...
            migrationBuilder.CreateTable(
                name: "ProductVariantProductAttributeOptions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductAttributeOptionsId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ProductVariantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVariantProductAttributeOptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductVariantProductAttributeOptions_ProductAttributeOptions_ProductAttributeOptionsId",
                        column: x => x.ProductAttributeOptionsId,
                        principalTable: "ProductAttributeOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductVariantProductAttributeOptions_ProductVariants_ProductVariantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserCompanies_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemGroupProducts_ProductGroupId",
                table: "ItemGroupProducts",
                column: "ProductGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemGroupProducts_ProductId",
                table: "ItemGroupProducts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemUnits_CompanyId",
                table: "ItemUnits",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemUnits_ParentId",
                table: "ItemUnits",
                column: "ParentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ledgers_LedgerCategoryId",
                table: "Ledgers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductAttributes_ProductCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantProductAttributeOptions_ProductAttributeOptionsId",
                table: "ProductVariantProductAttributeOptions",
                column: "ProductAttributeOptionsId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantProductAttributeOptions_ProductVariantId",
                table: "ProductVariantProductAttributeOptions",
