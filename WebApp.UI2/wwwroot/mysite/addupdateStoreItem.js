...
$('.btnadd').on("click", function (e) {
    ...
    let txtConsumedQuantity = $("#txtConsumedQuantity").val();
    ...
    $('#tbodyitems tr').each(function () {
        let text = $(this).find("td").eq(5).html();
        if (text !== "Total") {
            ...
            newcontent += "<td>" + $(this).find("td").eq(6).html(); + " </td >";
            ...
            let hdnappendConsumedQuantity = $(this).find('.hdnappendConsumedQuantity').val();
            let hdnappendStoreProductId = $(this).find(".hdnappendStoreProductId").val();
            let hdnappendhdnStoreItemId = $(this).find(".hdnappendhdnStoreItemId").val();
            let hdnappendStatus = $(this).find(".hdnappendStatus").val();            
            ...
            newcontent += "<input type='hidden' class='hdnappendStoreProductId' value=" + hdnappendStoreProductId + " />";
            ...
            newcontent += "<input type='hidden' class='hdnappendConsumedQuantity' value=" + hdnappendConsumedQuantity + " />";
            newcontent += "<input type='hidden' class='hdnappendhdnStoreItemId' value=" + hdnappendhdnStoreItemId + " />";
            newcontent += "<input type='hidden' class='hdnappendStatus' value=" + hdnappendStatus + " />";
    ...
    newcontent += "<input type='hidden' class='hdnappendConsumedQuantity' value=" + txtConsumedQuantity + " />";
    ...
    newcontent += "<input type='hidden' class='hdnappendStatus' value=" + txtStatus + " />";
    newcontent += "<a  class='fa fa-edit edit' style='cursor:pointer;'/>";
    newcontent += "<a  class='fa fa-trash delete' style='cursor:pointer;'/>";
    newcontent += "</td >";
    newcontent += "</tr >";
